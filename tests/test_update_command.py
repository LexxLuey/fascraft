...
from fascraft.commands.update import (
    analyze_module,
    confirm_update,
    create_backup,
...
class TestUpdateModuleFiles:
    ...
    @patch("fascraft.commands.update.Environment")
...
class TestUpdateModule:
    ...
    @patch("fascraft.commands.update.is_fastapi_project")
    @patch("fascraft.commands.update.is_domain_module")
    @patch("fascraft.commands.update.analyze_module")
    @patch("fascraft.commands.update.display_update_preview")
    @patch("fascraft.commands.update.confirm_update")
    @patch("fascraft.commands.update.create_backup")
    @patch("fascraft.commands.update.update_module_files")
