...
class TestCreateProjectWithRollback:
    ...
    def test_create_project_with_rollback_success(
        ...
        mock_validate_disk.assert_called_once_with(project_path.parent, required_space_mb=20)
...
class TestCreateBackupDirectory:
    ...
    def test_create_backup_directory_success(self, mock_datetime, mock_copytree, tmp_path):
    ...
    @patch("shutil.copytree")
    @patch("fascraft.commands.new.datetime")
    def test_create_backup_directory_failure(self, mock_datetime, mock_copytree, tmp_path):
...
class TestRollbackProjectCreation:
    ...
    @patch("shutil.copytree")
    @patch("shutil.rmtree")
    def test_rollback_project_creation_with_backup(self, mock_rmtree, mock_copytree, tmp_path):
    ...
    @patch("shutil.copytree")
    @patch("shutil.rmtree")
    def test_rollback_project_creation_no_backup(self, mock_rmtree, mock_copytree, tmp_path):
    ...
    @patch("shutil.copytree")
    @patch("shutil.rmtree")
    def test_rollback_project_creation_rollback_failure(self, mock_rmtree, mock_copytree, tmp_path):
...
class TestRenderEssentialTemplates:
    ...
    def test_render_essential_templates_success(self, mock_render_single, tmp_path):
        ...
        mock_render_single.assert_any_call(project_path, project_name, "main.py.jinja2", "main.py")
        mock_render_single.assert_any_call(project_path, project_name, "pyproject.toml.jinja2", "pyproject.toml")
        mock_render_single.assert_any_call(project_path, project_name, "requirements.txt.jinja2", "requirements.txt")
        mock_render_single.assert_any_call(project_path, project_name, "__init__.py.jinja2", "__init__.py")
        mock_render_single.assert_any_call(project_path, project_name, "config/__init__.py.jinja2", "config/__init__.py")
        mock_render_single.assert_any_call(project_path, project_name, "config/settings.py.jinja2", "config/settings.py")
        mock_render_single.assert_any_call(project_path, project_name, "routers/__init__.py.jinja2", "routers/__init__.py")
        mock_render_single.assert_any_call(project_path, project_name, "routers/base.py.jinja2", "routers/base.py")

    @patch("fascraft.commands.new.render_single_template")
    def test_render_essential_templates_partial_failure(self, mock_render_single, tmp_path):
...
class TestRenderSingleTemplate:
    ...
    def test_render_single_template_not_found(self, mock_env_class, tmp_path):
        ...
        mock_env = MagicMock()
        mock_env.get_template.side_effect = FileNotFoundError("No such file or directory")
        mock_env_class.return_value = mock_env
        ...
        with pytest.raises(TemplateNotFoundError) as exc_info:
            render_single_template(project_path, project_name, "missing.jinja2", "missing.py")
    ...
    def test_render_single_template_corrupted(self, mock_env_class, tmp_path):
        ...
        with pytest.raises(CorruptedTemplateError) as exc_info:
            render_single_template(project_path, project_name, "corrupted.jinja2", "corrupted.py")
