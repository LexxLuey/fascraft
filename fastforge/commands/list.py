...
def list_modules(
    ...
    if not modules:
        ...
        info_text.append("\nUse ", style="white")
        info_text.append("'fastforge generate <module_name>' ", style="bold cyan")
...
def display_modules_table(modules: List[dict], project_path: Path) -> None:
    ...
    footer_text.append("'fastforge remove <module>' ", style="bold cyan")
    footer_text.append("to remove a module, ", style="white")
    footer_text.append("'fastforge update <module>' ", style="bold cyan")
