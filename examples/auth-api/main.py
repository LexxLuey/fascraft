...
app = FastAPI(
    ...
    description="A FastAPI project generated with FasCraft - Authentication API Example",
...
async def root():
    """Root endpoint."""
    return {"message": f"Welcome to {settings.app_name} - Authentication API!", "status": "running"}
