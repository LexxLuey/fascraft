...
products = [
    ...
    {"id": 2, "name": "Smartphone", "price": 599.99, "category": "Electronics", "stock": 15},
    {"id": 3, "name": "Headphones", "price": 99.99, "category": "Electronics", "stock": 25},
    {"id": 4, "name": "Coffee Mug", "price": 19.99, "category": "Home", "stock": 50}
]

orders = [
    {"id": 1, "customer_id": 101, "products": [{"product_id": 1, "quantity": 1}], "total": 999.99, "status": "completed"},
    {"id": 2, "customer_id": 102, "products": [{"product_id": 2, "quantity": 1}, {"product_id": 3, "quantity": 1}], "total": 699.98, "status": "pending"}
]

@app.get("/")
async def root():
    """Root endpoint."""
    return {"message": f"Welcome to {settings.app_name} - E-commerce API!", "status": "running"}
